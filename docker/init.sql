-- Docker 환경용 데이터베이스 초기화
-- MariaDB 컨테이너의 /docker-entrypoint-initdb.d/에 마운트됨

CREATE DATABASE IF NOT EXISTS riseone CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE riseone;
